...
gestureDescription.addDirection(Finger.Index, FingerDirection.DiagonalUpLeft, 0.75);
gestureDescription.addDirection(Finger.Index, FingerDirection.DiagonalDownLeft, 0.75);
